...
let resultsVisibleBeforeProfile = false;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  profileBackBtn.addEventListener("click", showAppPage);
...
function showProfilePage() {
  ...
  resultsVisibleBeforeProfile = !results.classList.contains("hidden");
  ...
  if (resultsVisibleBeforeProfile) {
...
function renderProfilePage() {
  ...
  const attractions = JSON.parse(localStorage.getItem("favorite_attractions")) || [];
  const history = JSON.parse(localStorage.getItem("history")) || [];

  document.getElementById("profile-history-count").textContent = history.length;
  document.getElementById("profile-favorites-count").textContent = favorites.length;
  document.getElementById("profile-attractions-count").textContent = attractions.length;
}
